      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div ref={ref} className="reveal text-center max-w-3xl mx-auto">
          ...
          <h2 className="mt-6 font-serif text-5xl md:text-6xl lg:text-7xl tracking-tight text-ink leading-[1.05]">
            Vuoi lavorare{" "}
            <span className="italic text-[#0097B2]">con me?</span>
          </h2>

          <p className="mt-8 text-base md:text-lg font-light text-stone leading-relaxed max-w-xl mx-auto">
            Scrivimi per collaborazioni, progetti social, contenuti UGC,
            gestione profili o campagne digitali.
          </p>
        </div>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="inline-flex items-center justify-center w-11 h-11 rounded-full bg-sand text-ink group-hover:bg-[#0097B2] group-hover:text-white transition-colors duration-300">
          {icon}
        </span>
        ...
        <ArrowUpRight
          size={18}
          strokeWidth={1.5}
          className="text-stone group-hover:text-[#0097B2] transition-colors duration-300"
        />
      </div>

      <p className="mt-5 text-xs uppercase tracking-[0.15em] text-stone">
        {label}
      </p>

      <p className="mt-1 text-base font-medium text-ink break-words">
        {value}
      </p>
    </a>
  );
