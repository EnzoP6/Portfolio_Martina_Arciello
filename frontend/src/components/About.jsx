  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="mt-16">
          <h3 className="font-serif text-3xl md:text-4xl text-ink mb-8">
            What I do
          </h3>
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <h4 className="font-serif text-2xl md:text-3xl text-ink transition-colors duration-300 group-hover:text-[#0097B2]">
          {skill.title}
        </h4>
      </div>
